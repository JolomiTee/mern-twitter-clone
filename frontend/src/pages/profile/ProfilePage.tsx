...
const ProfilePage = () => {
	...
	const handleImgChange = (e: any, state: any) => {
		...
		if (file) {
			...
			reader.onload = () => {
				...
				// Ensure result is a string before setting it to the src attribute
	...
	const amIFollowing = user ? authUser?.following.includes(user._id) : false;
